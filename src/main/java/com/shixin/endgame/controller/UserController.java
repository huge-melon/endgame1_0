...
import com.shixin.endgame.entity.RegularExpress;
import com.shixin.endgame.service.CleanService;
import com.shixin.endgame.service.ConnectService;
...
public class UserController {
    ...
    @Autowired
    private ConnectService connectService;//连接数据库
    //负责数据库连接
    ...
    public Map<String, Object> addDatabse(@RequestBody DBinfo dBinfo) throws Exception {
        connectService.setDataSource(dBinfo);
        ...
        addDBname.put("children", queryService.getTableName(dBinfo.getDbType(), dBinfo.getDbName(), connectService.getDateSource(dBinfo.getDbType(), dBinfo.getDbName())));
    ...
    public List<Map<String, Object>> getTableName(@RequestParam String dbType, @RequestParam String dbName) {
        ...
        //这里应该写到Service层中
        return queryService.getTableName(dbType, dbName, connectService.getDateSource(dbType, dbName));
    ...
    public List<Map<String, Object>> getTableData(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName) {
        return queryService.getTableData(dbType, tableName, connectService.getDateSource(dbType, dbName));
    }
    ...
    public List<Map<String, Object>> getTableMetaData(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName) {
        return queryService.getTableMetaData(dbType, dbName, tableName, connectService.getDateSource(dbType, dbName));
    }
    ...
    public List<Map<String, Object>> searchByCondition(@RequestParam String dbName, @RequestParam String collectionName, @RequestParam String key_field, @RequestParam String operation, @RequestParam String keyWord) {
        ...
        return queryService.searchByCondition(collectionName, key_field, operation, keyWord, connectService.getDateSource("MongoDB", dbName));
    }
    ...
    public boolean delDuplicatedData(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String columnsName, @RequestParam String id) {
        return cleanService.delDuplicatedData(dbType, tableName, columnsName, id, connectService.getDateSource(dbType, dbName));
    }
    ...
    public boolean delDataByNull(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String columnsName, @RequestParam String method) {
        return cleanService.delDataByNull(dbType, tableName, columnsName, method, connectService.getDateSource(dbType, dbName));
    }
    ...
    public boolean deleteTableColumn(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String columnName) {
        return cleanService.deleteTableColumn(dbType, tableName, columnName, connectService.getDateSource(dbType, dbName));
    }
    ...
    public boolean deleteByCondition(@RequestBody ConditionTable conditionTable) {
        ...
        return cleanService.deleteByCondition(conditionTable, connectService.getDateSource(conditionTable.getDbType(), conditionTable.getDbName()));
    }
    ...
    public boolean updateColumnType(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String column, @RequestParam String oldType, @RequestParam String newType) {
        return cleanService.updateColumnType(dbType, tableName, column, oldType, newType, connectService.getDateSource(dbType, dbName));
    }
    ...
    public boolean cutString(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String columnName, @RequestParam String priKey, @RequestParam String opType, @RequestParam String beginKey, @RequestParam String endKey) {
        return cleanService.cutString(dbType, tableName, columnName, priKey, opType, beginKey, endKey, connectService.getDateSource(dbType, dbName));
    }
    ...
    public boolean completFiled(@RequestParam String dbType, @RequestParam String dbName, @RequestParam String tableName, @RequestParam String columnName, @RequestParam String completType, @RequestParam String defaultValue) {
        return cleanService.completFiled(dbType, tableName, columnName, completType, defaultValue, connectService.getDateSource(dbType, dbName));
    }
   ...
   /* @GetMapping("/dataVerify")
    ...
    public List<Map<String, Object>> dataVerify(@RequestBody RegularExpress regularExpress) {
        System.out.println("data+++ " + regularExpress);
        return cleanService.dataVerify(regularExpress.getDbType(), regularExpress.getTableName(), regularExpress.getColumnName(), regularExpress.getPriKey(), regularExpress.getRegularExpress(), connectService.getDateSource(regularExpress.getDbType(), regularExpress.getDbName()));
    }

    @PostMapping("/replaceString")
    public List<Map<String, Object>> replaceString(@RequestBody RegularExpress regularExpress) {
        return cleanService.replaceString(regularExpress.getDbType(), regularExpress.getTableName(), regularExpress.getColumnName(), regularExpress.getPriKey(), regularExpress.getRegularExpress(), regularExpress.getTargetString(), connectService.getDateSource(regularExpress.getDbType(), regularExpress.getDbName()));
    }
    ...
    public boolean saveUpdateDate(@RequestBody Map<String, Object> receiveData) {
        ...
        return cleanService.saveUpdateDate(dbType, tableName, columnName, priKey, data, connectService.getDateSource(dbType, dbName));
    ...
    public boolean rdbToRdb(@RequestBody Map<String, Object> receiveData) {
        ...
        return storeService.rdbToRdb(sourceDbType, sourceTableName, sourceColumnList, targetDbType, targetTableName, targetColumnList, (SqlSessionFactory) connectService.getDateSource(sourceDbType, sourceDbName), (SqlSessionFactory) connectService.getDateSource(targetDbType, targetDbName));
    ...
    public boolean rdbToMongo(@RequestBody Map<String, Object> receiveData) {
        ...
        return storeService.rdbToMongo(sourceDbType, sourceTableName, sourceColumnList, targetCollectionName, (SqlSessionFactory) connectService.getDateSource(sourceDbType, sourceDbName), (MongoDbFactory) connectService.getDateSource(targetDbType, targetDbName));
    }
